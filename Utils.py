...
def writeImage(image, filename):
    ...
    g = image.copy()
    b = image.copy()
    label_colours = np.array([Background, Fence, Road, Roadside_things, Riders, Living_being, Sidewalk, Curb, Parking, Fallback, Heavy_vehicle, Non_fallback, obs_fallback, Unlabelled])
    for l in range(0,13):
        r[image==l] = label_colours[l,2]
        g[image==l] = label_colours[l,1]
        b[image==l] = label_colours[l,0]
